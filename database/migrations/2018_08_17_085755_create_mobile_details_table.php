...
class CreateMobileDetailsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('mobile_details', function (Blueprint $table) {
            ...
            $table->string('other_display_features')->nullable();
            ...
            $table->string('audio_formats')->nullable();
            $table->string('video_formats')->nullable();
            $table->string('battery_capacity')->nullable();
            $table->string('width')->nullable();
            $table->string('height')->nullable();
            $table->string('depth')->nullable();
            $table->string('weight')->nullable();
            $table->string('warranty_summery')->nullable();
